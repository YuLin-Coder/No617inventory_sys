								...
								<div class="col-5">
									<form id="saveForm" >
										...
										<div class="form-group">
											<label>商品名称</label> <select name="gid" class="form-control">
										...
										<div class="form-group">
											<label>负责人</label> <input type="text" name="charger"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>入库数量</label> <input type="number" name="nums"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>
	...
	<script>
		$("#save").click(function() {
			$.ajax({
				cache:true,
				type : "post",
				url : "CrkServlet?action=addCrk",
				data : $("#saveForm").serialize(),
				async:false,
				success : function(e) {
					if (e == "yes") {
						alert("操作成功！");
						window.parent.location.href = "CrkServlet?action=CrkList";
					} else{
						alert("操作失败");
					}
				}
