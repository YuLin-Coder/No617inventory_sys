							...
							<div class="row">
								<div class="col-5">
									<form id="saveForm" >
										...
										<div class="form-group">
											<label>工号</label> <input type="text" name="eno"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>
										...
										<div class="form-group">
											<label>工作内容</label> <input type="text" name="work"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>角色</label> <select name="role" class="form-control">
	...
	<script>
		$("#save").click(function() {
			$.ajax({
				cache:true,
				type : "post",
				url : "EmployeeServlet?action=addEmployee",
