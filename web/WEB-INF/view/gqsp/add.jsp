								...
								<div class="col-5">
									<form id="saveForm" >
										...
										<div class="form-group">
											<label>过期商品名称</label> <input type="text" name="name"
										...
										<div class="form-group">
											<label>生产日期</label> <input type="text" name="create_date"
										...
										<div class="form-group">
											<label>保质期/月</label> <input type="number" name="bzq"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>记录入</label> <input type="text" name="jlr"
												class="form-control"> <small
												class="form-text text-muted"></small>
										</div>
	...
	<script>
		$("#save").click(function() {
			$.ajax({
				cache:true,
				type : "post",
				url : "GqspServlet?action=addGqsp",
