		...
		<main>
			...
			<div id="body">
				<main>
					<div class="main">
						<div class="search">
							<form class="form-inline float-left" action="GqspServlet?action=GqspList"
								method="post">
								<div class="form-group">
									<input type="text" name="key" value="${key}"
										class="form-control" placeholder="过期商品名称">
								</div>
									...
									<c:forEach items="${list}" var="data">
										<tr>
											...
											<a class="btn btn-primary btn-sm"
												href="GqspServlet?action=toUpdateGqsp&id=${data.id }">修改</a>
	...
	<script>
	  ...
	   $('a.delete').click(function(e) 
   		...
   		            var id = $(e.currentTarget).parent().find('.weui-input').attr('id');
			 		 ...
			 		 　 $.ajax({
						    cache:true,
							url:"GqspServlet?action=deleteGqsp",
						  	data:{"id": id},
							type:"post",
						    async:false,
