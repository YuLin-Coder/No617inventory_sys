								...
								<div class="col-5">
									...
									<input type="hidden" name="id" value="${data.id }">
										...
										<div class="form-group">
											<label>公告标题</label> <input type="text" name="title" value="${data.title }"
																	   class="form-control"> <small
												class="form-text text-muted"></small>
										</div>
										<div class="form-group">
											<label>公告内容</label> <input type="text" name="content" value="${data.content }"
																	   class="form-control"> <small
												class="form-text text-muted"></small>
										</div>

										<div class="form-group">
											<label>发布人</label> <input type="text" name="editor" value="${data.editor }"
																	  class="form-control"> <small
												class="form-text text-muted"></small>
										</div>
									</form>
